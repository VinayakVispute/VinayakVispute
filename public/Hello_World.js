...
intent('Hello world', p => {
    p.play('Hi there its vinayak');
});
intent('Who is Princy', p => {
    p.play('Princy is a a girl which is studying in msu.She is very cute and good hearted and strong will and positive attitude girl but she has mastery in ignoring and saying hmm and she would always lie about her relation ship');
});
...
intent('Sing a birthday song for me', p => {
    p.play('Happy Birthday to you,');
    p.play('Happy Birthday to you,');
    p.play('Happy Birthday dear Vinayak,');
    p.play('Happy Birthday to you!');
});
...
intent('Do you know about my crush ?',p=>{
p.play('obviously i know its jeena ortega lol')
